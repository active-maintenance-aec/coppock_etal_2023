...
locus <- tribble(
  ...
  "art_intro_persist_w2", "unresolved",
    "No expression in the deposit or the rewrite returns 66 per cent. The pre-analysis plan's own ratio estimator, which the appendix prints, gives 49 per cent adjusted and 54 per cent unadjusted.",
  "res_persist_w2_precise", "unresolved",
    "As art_intro_persist_w2. The pooled Wave 2 effect is 47 per cent of the pooled Wave 1 effect.",
  "disc_persist_w2", "unresolved", "As art_intro_persist_w2.",
  "art_intro_persist_w3", "unresolved",
    "No expression returns 50 per cent. The appendix's own ratio row gives 43 per cent adjusted and 39 per cent unadjusted.",
  "res_persist_w3_precise", "unresolved", "As art_intro_persist_w3.",
  "disc_persist_w3", "unresolved", "As art_intro_persist_w3.",
